...
namespace DapperExtensions
{
    public static class DapperExtensions
    {
        ...
        public static IEnumerable<T> GetList<T>(this IDbConnection connection, IClassMapper classMap, object predicate = null, IList<ISort> sort = null, IDbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : class
        {
            return Instance().GetList<T>(connection, classMap, predicate, sort, transaction, commandTimeout, buffered);
        }

        public static IEnumerable<T> GetPage<T>(this IDbConnection connection, int page, int resultsPerPage, out long allRowsCount, string sql, dynamic param = null, string allRowsCountSql = null, IDbTransaction transaction = null, int? commandTimeout = null, bool buffered = false) where T : class
        {
            return Instance().GetPage<T>(connection, page, resultsPerPage, out allRowsCount, sql, param, allRowsCountSql, transaction, commandTimeout, buffered);
        }
