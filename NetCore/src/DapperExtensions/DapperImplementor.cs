...
namespace DapperExtensions
{
    public interface IDapperImplementor
    {
        ...
        IEnumerable<T> GetList<T>(IDbConnection connection, IClassMapper classMap, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class;
    ...
    internal class DapperImplementor : IDapperImplementor
    {
        ...
        public IEnumerable<T> GetList<T>(IDbConnection connection, IClassMapper classMap, object predicate, IList<ISort> sort, IDbTransaction transaction, int? commandTimeout, bool buffered) where T : class
        {
            IPredicate wherePredicate = GetPredicate(classMap, predicate);
            return GetList<T>(connection, classMap, wherePredicate, sort, transaction, commandTimeout, true);
        }
