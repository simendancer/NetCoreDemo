...
namespace DataAccess.SqlDBHelper
{
    ...
    public class SQLHelper
    {
        #region 私有方法和工具
        //sql
        private static void PrepareCommand(SqlCommand command, SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, IDataParameter[] commandParameters, out bool mustCloseConnection)
        {
        ...
        //通用
        private static void PrepareCommand(SqlCommand command, DbConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, IDataParameter[] commandParameters, out bool mustCloseConnection)
        {
        ...
        /// <param name="commandParameters">ＳＱＬ语句或者存储过程参数</param>
        /// <returns>影响的行数</returns>
        public static int ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            int retval = 0;
            //要检查参数
            SqlCommand cmd = new SqlCommand();
        ...
        //public static DataSet ExecuteDataset(SqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        //{
        ...
        //    SqlCommand cmd = new SqlCommand();
        //    bool mustCloseConnection = false;
        //    PrepareCommand(cmd, (SqlConnection)transaction.Connection, (SqlTransaction)transaction, commandType, commandText, commandParameters, out mustCloseConnection);
        //    using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        //    {
        //        DataSet ds = new DataSet();
        //        da.Fill(ds);
        ...
        //通用
        private static SqlDataReader ExecuteReader(SqlConnection connection, SqlTransaction transaction, CommandType commandType, string commandText, IDataParameter[] commandParameters, bool isClose)
        {
            bool mustCloseConnection = false;
        ...
        /// <param name="commandParameters">ＳＱＬ语句或者存储过程参数</param>
        /// <returns>执行结果集</returns>
        public static SqlDataReader ExecuteReader(SqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
        ...
        /// <param name="commandText">ＳＱＬ语句或者存储过程名</param>n
        /// <returns>执行结果集</returns>
        public static SqlDataReader ExecuteReader(IDbTransaction transaction, CommandType commandType, string commandText)
        {
            bool mustCloseConnection = false;
            return ExecuteReader((SqlConnection)transaction.Connection, (SqlTransaction)transaction, commandType, commandText, (IDataParameter[])null, mustCloseConnection);
        }
        ...
        /// <param name="commandParameters">ＳＱＬ语句或者存储过程参数</param>
        /// <returns>执行结果集</returns>
        public static SqlDataReader ExecuteReader(IDbTransaction transaction, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            bool mustCloseConnection = false;
            return ExecuteReader((SqlConnection)transaction.Connection, (SqlTransaction)transaction, commandType, commandText, commandParameters, mustCloseConnection);
        }
        ...
        public static object ExecuteScalar(SqlConnection connection, CommandType commandType, string commandText, params IDataParameter[] commandParameters)
        {
            object retval = null;
            SqlCommand cmd = new SqlCommand();
            bool mustCloseConnection = false;
        ...
        public static object ExecuteScalar(IDbTransaction transaction, CommandType commandType, string commandText)
        {
            ...
            SqlCommand cmd = new SqlCommand();
            bool mustCloseConnection = false;
            PrepareCommand(cmd, ((SqlTransaction)transaction).Connection, (SqlTransaction)transaction, commandType, commandText, (IDataParameter[])null, out mustCloseConnection);
            retval = cmd.ExecuteScalar();
            cmd.Parameters.Clear();
            return retval;
        }
